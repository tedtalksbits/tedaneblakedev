...
import { header_intro } from "../../data/textContent";
...
const Header = () => {
  return (
    <Container className="section" id="home" style={{ overflow: "hidden" }}>
      <div className="text">
        <Fade top>
          <Heading>{header_intro.heading1}</Heading>
          <Heading>{header_intro.heading2}</Heading>
          <SubHeading>{header_intro.subheading}</SubHeading>
        </Fade>
        <div
        ...
        >
          <Button
            ...
            href="#projects"
          >
            Projects <i className="bx bx-right-arrow-alt"></i>
          </Button>
        </div>
      </div>
      <Fade right>
